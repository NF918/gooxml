...
import (
	...
	"github.com/NF918/gooxml/schema/soo/ofc/extended_properties"
)
...
func NewAppProperties() AppProperties {
	...
	p.SetApplication("github.com/NF918/gooxml")
	p.SetDocSecurity(0)
...
// For gooxml created documents, it defaults to github.com/NF918/gooxml
